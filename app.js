...
const COURSES = [
  {
    ...
    price: 0,
    status: "published",
    shortDescription: "Learn the building blocks of the modern web with HTML5 and CSS3.",
    whatYouLearn: [
    ...
    curriculum: [
      ...
      },
      {
        ...
        lessons: [
          { id: "c001-s2-l1", title: "2.1 Introduction to CSS", durationMin: 5 },
          { id: "c001-s2-l2", title: "2.2 Selectors and Properties", durationMin: 10 },
          { id: "c001-s2-l3", title: "2.3 The Box Model", durationMin: 8 },
          { id: "c001-s2-l4", title: "2.4 Colors and Typography", durationMin: 7 }
        ],
        quiz: [
          {
            id: "c001-s2-q1",
      ...
      },
      {
        ...
        lessons: [
          { id: "c001-s3-l1", title: "3.1 Introduction to Flexbox", durationMin: 10 },
          { id: "c001-s3-l2", title: "3.2 Flexbox Layout Techniques", durationMin: 12 },
        ...
        quiz: [
          {
            ...
            options: ["flex: 1", "display: flex", "flexbox: true", "container: flex"],
            correctIndex: 1
          },
          {
            id: "c001-s3-q2",
          ...
          },
          {
            ...
            options: ["@media (max-width: 576px)", "@media (min-width: 768px)", "@media (min-width: 992px)", "@media (max-width: 1200px)"],
            correctIndex: 1
          }
        ]
      }
  ...
  },
  {
    ...
    price: 49,
    status: "published",
    shortDescription: "Master JavaScript fundamentals and ES6+ features for modern web development.",
    whatYouLearn: [
    ...
    curriculum: [
      {
        ...
        lessons: [
          { id: "c002-s1-l1", title: "1.1 Introduction to JavaScript", durationMin: 5 },
          { id: "c002-s1-l2", title: "1.2 Variables and Data Types", durationMin: 8 },
          { id: "c002-s1-l3", title: "1.3 Operators and Expressions", durationMin: 6 }
        ],
        quiz: [
          {
            id: "c002-s1-q1",
      ...
      },
      {
        ...
        lessons: [
          { id: "c002-s2-l1", title: "2.1 Function Declarations and Expressions", durationMin: 10 },
          { id: "c002-s2-l2", title: "2.2 Arrow Functions", durationMin: 8 },
          { id: "c002-s2-l3", title: "2.3 Working with Arrays", durationMin: 10 },
          { id: "c002-s2-l4", title: "2.4 Array Methods (map, filter, reduce)", durationMin: 12 }
        ],
        quiz: [
          {
            id: "c002-s2-q1",
  ...
  },
  {
    ...
    price: 59,
    status: "published",
    shortDescription: "Create beautiful and user-centered designs that delight users.",
    whatYouLearn: [
    ...
    curriculum: [
      {
        ...
        lessons: [
          { id: "c003-s1-l1", title: "1.1 Introduction to UI/UX", durationMin: 5 },
      ...
      },
      {
        ...
        lessons: [
          { id: "c003-s2-l1", title: "2.1 Understanding User Needs", durationMin: 10 },
          { id: "c003-s2-l2", title: "2.2 Creating User Personas", durationMin: 8 },
          { id: "c003-s2-l3", title: "2.3 User Journey Mapping", durationMin: 10 },
          { id: "c003-s2-l4", title: "2.4 Information Architecture", durationMin: 8 }
        ],
        quiz: [
          {
            id: "c003-s2-q1",
          ...
          },
          {
            ...
            options: ["Code review", "Unit testing", "User interviews", "Server logs"],
            correctIndex: 2
          }
        ]
      },
      {
        ...
        lessons: [
          { id: "c003-s3-l1", title: "3.1 Getting Started with Figma", durationMin: 8 },
          { id: "c003-s3-l2", title: "3.2 Creating Components", durationMin: 10 },
          { id: "c003-s3-l3", title: "3.3 Building Interactive Prototypes", durationMin: 12 }
        ],
        quiz: [
          {
            id: "c003-s3-q1",
    ...
    curriculum: [
      {
        ...
        lessons: [
          { id: "c004-s1-l1", title: "1.1 Introduction to Python", durationMin: 5 },
          { id: "c004-s1-l2", title: "1.2 Variables and Data Types", durationMin: 8 },
          { id: "c004-s1-l3", title: "1.3 Control Flow and Functions", durationMin: 10 }
        ],
        quiz: [
          {
            id: "c004-s1-q1",
      ...
      },
      {
        ...
        lessons: [
          { id: "c004-s2-l1", title: "2.1 Introduction to Pandas", durationMin: 8 },
          { id: "c004-s2-l2", title: "2.2 DataFrames Basics", durationMin: 10 },
          { id: "c004-s2-l3", title: "2.3 Data Cleaning and Preparation", durationMin: 12 },
          { id: "c004-s2-l4", title: "2.4 Aggregation and Grouping", durationMin: 10 }
        ],
        quiz: [
          {
            id: "c004-s2-q1",
            question: "What does a DataFrame represent?",
            options: ["A single value", "A one-dimensional array", "A two-dimensional labeled data structure", "A function"],
            correctIndex: 2
          },
          {
            id: "c004-s2-q2",
          ...
          },
          {
            ...
            options: ["Not a Name", "Not a Null", "Not a Number", "New Array Name"],
            correctIndex: 2
          }
        ]
      },
      {
        ...
        lessons: [
          { id: "c004-s3-l1", title: "3.1 Introduction to Matplotlib", durationMin: 8 },
          { id: "c004-s3-l2", title: "3.2 Creating Line and Bar Charts", durationMin: 10 },
          { id: "c004-s3-l3", title: "3.3 Advanced Visualizations with Seaborn", durationMin: 12 },
          { id: "c004-s3-l4", title: "3.4 Interactive Plots with Plotly", durationMin: 10 }
        ],
        quiz: [
          {
            id: "c004-s3-q1",
          ...
          },
          {
            ...
            options: ["plot.line()", "plot.bar()", "plot.hist()", "plot.scatter()"],
            correctIndex: 2
          }
        ]
      }
  ...
  },
  {
    ...
    price: 39,
    status: "published",
    shortDescription: "Master digital marketing channels, SEO, social media, and analytics.",
    whatYouLearn: [
    ...
    curriculum: [
      {
        ...
        lessons: [
          { id: "c005-s1-l1", title: "1.1 Introduction to Digital Marketing", durationMin: 5 },
          { id: "c005-s1-l2", title: "1.2 Understanding Your Audience", durationMin: 8 },
          { id: "c005-s1-l3", title: "1.3 Building a Marketing Strategy", durationMin: 10 }
        ],
        quiz: [
          {
            id: "c005-s1-q1",
            question: "What is the first step in creating a marketing strategy?",
            options: ["Post on social media", "Define goals and target audience", "Buy advertising", "Create a website"],
            correctIndex: 1
          },
          {
            id: "c005-s1-q2",
          ...
          },
          {
            ...
            options: ["Social media", "Television ads", "Email marketing", "SEO"],
            correctIndex: 1
          }
        ]
      },
      {
        ...
        lessons: [
          ...
          { id: "c005-s2-l2", title: "2.2 On-Page SEO Techniques", durationMin: 12 },
          { id: "c005-s2-l3", title: "2.3 Content Marketing Strategy", durationMin: 10 },
          { id: "c005-s2-l4", title: "2.4 Link Building Strategies", durationMin: 8 }
        ],
        quiz: [
          {
            id: "c005-s2-q1",
          ...
          },
          {
            ...
            options: ["Meta keywords tag", "Quality content", "Font color", "Page animations"],
            correctIndex: 1
          },
          {
            id: "c005-s2-q3",
      ...
      },
      {
        ...
        lessons: [
          { id: "c005-s3-l1", title: "3.1 Social Media Platforms Overview", durationMin: 8 },
          { id: "c005-s3-l2", title: "3.2 Creating Engaging Content", durationMin: 10 },
          { id: "c005-s3-l3", title: "3.3 Social Media Advertising", durationMin: 12 }
        ],
        quiz: [
          {
            id: "c005-s3-q1",
  ...
  },
  {
    ...
    price: 0,
    status: "published",
    shortDescription: "Create websites that look great on any device with modern CSS techniques.",
    whatYouLearn: [
    ...
    curriculum: [
      {
        ...
        lessons: [
          { id: "c006-s1-l1", title: "1.1 Why Mobile-First Design", durationMin: 5 },
          { id: "c006-s1-l2", title: "1.2 Viewport and Media Queries", durationMin: 10 },
      ...
      },
      {
        ...
        lessons: [
          { id: "c006-s2-l1", title: "2.1 Flex Container Properties", durationMin: 10 },
          { id: "c006-s2-l2", title: "2.2 Flex Item Properties", durationMin: 10 },
          { id: "c006-s2-l3", title: "2.3 Building Flexbox Layouts", durationMin: 12 }
        ],
        quiz: [
          {
            id: "c006-s2-q1",
      ...
      },
      {
        ...
        lessons: [
          { id: "c006-s3-l1", title: "3.1 Grid Container Setup", durationMin: 8 },
          { id: "c006-s3-l2", title: "3.2 Grid Template Areas", durationMin: 10 },
          { id: "c006-s3-l3", title: "3.3 Responsive Grid Patterns", durationMin: 12 }
        ],
        quiz: [
          {
            id: "c006-s3-q1",
            question: "How do you create a grid container?",
            options: ["display: flexbox", "display: grid", "display: table", "display: block"],
            correctIndex: 1
          },
          {
            id: "c006-s3-q2",
